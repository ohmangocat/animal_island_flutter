...
这个示例项目复刻 React `animal-island-ui` demo 的页面编排，并把所有示例改写为 Flutter 使用方式。它用于预览首页、组件列表、组件详情页、代码示例和跨端视觉效果。
...
| 项目 | 版本 |
| --- | --- |
| `animal_island_flutter` | 发布版 `^0.1.3` |
| GitHub | `https://github.com/ohmangocat/animal_island_flutter` |
| Flutter SDK | `>=3.19.0` |
...
| Detail | 74 个组件页面，包含基础、扩展、进阶、阶段三、阶段四、移动端基础组件、移动业务组件和复杂组件的使用示例、代码块和 API 说明 |
